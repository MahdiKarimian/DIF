...
parser = argparse.ArgumentParser(description='python dif.py -o test.png -i sequence.fasta -size 1000')

parser.add_argument('-i', type=str,
                    help='fasta input file name',required=True)
                    
parser.add_argument('-o', type=str,
                    help='image output file name',required=True)
                    
parser.add_argument('-size', type=int,
                    help='image output size 1000-30000',required=True)

parser.add_argument('-recordid', type=str, default = '*',
                    help='image output size 1000-30000')


parser.add_argument('-plotsize', type=int, default = 10000000,
